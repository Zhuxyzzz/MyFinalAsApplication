package com.example.myfinalasapplication.teacher;
...
import com.example.myfinalasapplication.adapter.AttendDetailAdapter;
import com.example.myfinalasapplication.entity.AttendList;
...
public class TeacherRecordDetail extends AppCompatActivity {
    ...
    public void refreshButton(){
        findViewById(R.id.record_type_all).setBackground(ResourceUtils.getDrawable(R.color.black));
        findViewById(R.id.record_type_success).setBackground(ResourceUtils.getDrawable(R.color.black));
        findViewById(R.id.record_type_failure).setBackground(ResourceUtils.getDrawable(R.color.black));
        findViewById(R.id.record_type_absent).setBackground(ResourceUtils.getDrawable(R.color.black));
        findViewById(R.id.record_type_leave).setBackground(ResourceUtils.getDrawable(R.color.black));
    }
