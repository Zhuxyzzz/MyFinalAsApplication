...
import com.example.myfinalasapplication.entity.AccountStudent;
    ...
    public void onClicked(View view){
        switch (view.getId()){
            case R.id.confirm_resend:
                ...
                SMSSDK.getVerificationCode("86",student.getPhone());//方法不成功
                break;
            case R.id.confirm_confirm:
                if (codeEdit.getText().toString().isEmpty()){
                    ...
                    Log.e(student.getPhone(),codeEdit.getText().toString());
                    SMSSDK.submitVerificationCode("86",student.getPhone(),codeEdit.getText().toString());//好像无效
                    Log.e("test","手机验证直接成功");
